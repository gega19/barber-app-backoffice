...
"[project]/Desktop/projects/barber-application/barber-app-backoffice/lib/specialties.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const specialtiesService = {
    async getSpecialties () {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/specialties');
        return response.data.data;
    },
    async getSpecialtyById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/specialties/${id}`);
        return response.data.data;
    },
    async createSpecialty (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/specialties/admin', data);
        return response.data.data;
    },
    async updateSpecialty (id, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/specialties/admin/${id}`, data);
        return response.data.data;
    },
    async deleteSpecialty (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/specialties/admin/${id}`);
    }
};
...
"[project]/Desktop/projects/barber-application/barber-app-backoffice/app/dashboard/specialties/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$specialties$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/projects/barber-application/barber-app-backoffice/lib/specialties.ts [app-client] (ecmascript)");
...
;
;
const specialtySchema = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
function SpecialtiesPage() {
    _s();
    const [specialties, setSpecialties] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [selectedSpecialty, setSelectedSpecialty] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const { register, handleSubmit, formState: { errors }, reset } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        resolver: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f40$hookform$2f$resolvers$2f$zod$2f$dist$2f$zod$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodResolver"])(specialtySchema)
    });
    const loadSpecialties = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SpecialtiesPage.useCallback[loadSpecialties]": async ()=>{
            setIsLoading(true);
            try {
                const data = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$specialties$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["specialtiesService"].getSpecialties();
                setSpecialties(data);
            } catch (err) {
    ...
    }["SpecialtiesPage.useCallback[loadSpecialties]"], []);
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            if (isEditMode && selectedSpecialty) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$specialties$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["specialtiesService"].updateSpecialty(selectedSpecialty.id, updateData);
            } else {
                const createData = {
                    name: data.name,
                    description: data.description || undefined
                };
                await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$specialties$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["specialtiesService"].createSpecialty(createData);
            }
    ...
    const handleDelete = async (id)=>{
        try {
            setError(null);
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$specialties$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["specialtiesService"].deleteSpecialty(id);
...
_s(SpecialtiesPage, "YQBeqK2BZXdWHM0/ol6zaAlswTQ=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_projects_barber-application_barber-app-backoffice_29012261._.js.map