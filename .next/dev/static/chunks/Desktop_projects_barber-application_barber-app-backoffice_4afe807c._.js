...
const userSchema = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    password: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(6, 'La contraseña debe tener al menos 6 caracteres').optional(),
...
function UsersPage() {
    ...
    const { register, handleSubmit, formState: { errors }, reset, setValue } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
    ...
    const loadUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UsersPage.useCallback[loadUsers]": async ()=>{
            setIsLoading(true);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersService"].getUsers(currentPage, 10, searchTerm || undefined);
                let filteredUsers = response.data;
                // Load barbers to check user types
                const barbersResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$lib$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersService"].getBarbers();
                const barberEmails = new Set(barbersResponse.map({
                    "UsersPage.useCallback[loadUsers]": (b)=>b.email
                }["UsersPage.useCallback[loadUsers]"]));
                const barberMap = {};
                filteredUsers.forEach({
                    "UsersPage.useCallback[loadUsers]": (user)=>{
                ...
                if (roleFilter !== 'ALL') {
                    filteredUsers = filteredUsers.filter({
                        "UsersPage.useCallback[loadUsers]": (user)=>user.role === roleFilter
                    }["UsersPage.useCallback[loadUsers]"]);
                }
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                userBarberMap[user.id] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$projects$2f$barber$2d$application$2f$barber$2d$app$2d$backoffice$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(UsersPage, "O6ZKdqia+xVL5gaWkf0rKCJbHZA=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_projects_barber-application_barber-app-backoffice_4afe807c._.js.map